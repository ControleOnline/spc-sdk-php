---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/spc-sdk-php, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/spc-sdk-php`.
...
- Checkout local: `api-community/modules/controleonline/spc-sdk`
